...
import handler # file for custom function

# this is the AWS basic_discovery.py sample, 
# where handler.on_message(topic, message) has been added
...
if args.mode == 'both' or args.mode == 'subscribe':
    ...
    def on_publish(topic, payload, dup, qos, retain, **kwargs):
        ...
        print(payload)
        handler.on_message(topic, payload) # <-- custom function call inserted here
